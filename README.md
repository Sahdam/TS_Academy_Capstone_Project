...
| **Team C** | basket_price Modelling | `03_basket_price_models.ipynb` | Ojumoola Paul, @Samuel-Orinya, Abdulmalik Abdulrashid |
| **Team D** | cpi_food Modelling & Forecasts | `04_cpi_food_and_forecasts.ipynb` | @Maria-TSA, Fayemi Anthony Olatokunbo, @Sopuruchilizbeth |
